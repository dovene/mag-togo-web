      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index.php">Gestionnaire des articles</a></li>
...
$query->execute(array(':lib' => $lib, ':image' => $fichier));
		...
		while($r = $qur->fetch(PDO::FETCH_OBJ)){
		  ...
		  ($ligne % 2 == 0) ? ($bg_color = '') : ($bg_color = '#E7E7E7');
                        ...
                        <tr >
                            ...
                            <td align="left">
                                <?php echo stripslashes($r->imgCategory) ?>
                            </td>
                            <td align="left">
                            <img src="Divers.jpg" alt="Mountain View" style="width:304px;height:228px;">
                              </td>          
                        <?php

                        echo '<td>'.'<a title="" onclick="functionNA()">Modifier</a></td>
                        <td><a href="index.php?id='.stripslashes($r->id).'">Supprimer</a></td>';
                         ?>
                        </tr>
                        <?php
                        $ligne++;
